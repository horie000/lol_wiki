...
- **実測ビルド候補：** サンダード スカイ + 赤月の刃（該当n=34、47.1% / 非該当45.0%、差+2.1pt）
- **ステータス傾向：** 魔法防御（該当n=34、50.0% / 非該当44.0%、差+6.0pt）
- **理論仮説：** ショウジンの矛 + サンダード スカイ（n=2（15未満）；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）；ブラック クリーバー + ショウジンの矛（n=1（15未満）；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）
