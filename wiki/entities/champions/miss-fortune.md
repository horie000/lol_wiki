...
- **高勝率コンボ候補：** [[wiki/entities/champions/galio|ガリオ（Galio）]] — 対象側勝率62.4%（53/85）、n=85（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率44.2%（88/199）、n=199（十分性の目安を満たす）。
