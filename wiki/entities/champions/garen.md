...
- **高勝率コンボ候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率61.7%（58/94）、n=94（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/darius|ダリウス（Darius）]] — 対象側勝率39.0%（23/59）、n=59（十分性の目安を満たす）。
