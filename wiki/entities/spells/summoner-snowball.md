...
# マーク（SummonerSnowball）

## 概要

- **日本語名：** マーク
- **レコードID：** `SummonerSnowball`
- **キー：** `32`
- **データversion：** `16.18.1`
...
| 項目 | 原典値 |
| --- | --- |
| 利用可能モード | `KIWI`、`KIWI_JADE`、`ARAM`、`FIRSTBLOOD` |
| 解禁レベル | 6 |
| 最大ランク | 1 |
...
| コスト種別 | コスト無し |
| リソース | コスト無し |
| 射程 | 1600（rangeBurn: `1600`） |
| 最大弾薬 | -1 |
| 画像ファイル | `SummonerSnowball.png` |
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1]] — `16.18.1/data/ja_JP/summoner.json` の `SummonerSnowball` レコード。
