...
- **実測ビルド候補：** リデンプション + ムーンストーンの再生（該当n=39、51.3% / 非該当47.2%、差+4.1pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** ムーンストーンの再生 + ヘリアの残響（n=6（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）；メジャイ ソウルスティーラー + ムーンストーンの再生（n=5（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）
