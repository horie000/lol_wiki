...
- **高勝率コンボ候補：** [[wiki/entities/champions/smolder|スモルダー（Smolder）]] — 対象側勝率63.6%（28/44）、n=44（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率47.4%（27/57）、n=57（十分性の目安を満たす）。
