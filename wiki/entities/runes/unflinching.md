...
「気迫」は、不滅（Resolve）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット4（第3列）に配置されている。
...
- スロット番号: `4`
- スロット種別: 第3列
- アイコンパス: `perk-images/Styles/Sorcery/Unflinching/Unflinching.png`

## 効果（短い説明）

行動妨害効果を受けると物理防御と魔法防御が増加する。

## 効果（詳細）

行動妨害効果を受けている間とその後の2秒間、物理防御と魔法防御が10増加する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 不滅 / 気迫 レコード。
