...
- **実測ビルド候補：** グインソー レイジブレード + ルインドキング ブレード（該当n=37、45.9% / 非該当39.6%、差+6.4pt）；グインソー レイジブレード + テルミヌス（該当n=30、43.3% / 非該当41.8%、差+1.5pt）
- **ステータス傾向：** 魔法防御（該当n=31、51.6% / 非該当37.0%、差+14.6pt）
- **理論仮説：** スタティック シヴ + クラーケン スレイヤー（未観測；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 攻撃力）；スタティック シヴ + テルミヌス（n=11（15未満）；共通stats: 攻撃力・攻撃速度／チャンピオン原典にも言及: 攻撃力）
