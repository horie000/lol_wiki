...
「追い風」は、魔道（Sorcery）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット3（第2列）に配置されている。
...
- スロット番号: `3`
- スロット種別: 第2列
- アイコンパス: `perk-images/Styles/Sorcery/Celerity/CelerityTemp.png`

## 効果（短い説明）

自身のあらゆる移動速度ボーナスの効果が7%上昇し、移動速度が1%増加する。

## 効果（詳細）

自身のあらゆる移動ボーナスの効果が7%上昇し、移動速度が1%増加する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 魔道 / 追い風 レコード。
