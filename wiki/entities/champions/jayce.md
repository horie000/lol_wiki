...
- **実測ビルド候補：** 妖夢の霊剣 + セリルダの怨恨（該当n=40、67.5% / 非該当41.8%、差+25.7pt）；ムラマナ + 妖夢の霊剣 + セリルダの怨恨（該当n=35、65.7% / 非該当43.0%、差+22.7pt）
- **ステータス傾向：** 体力（該当n=151、48.3% / 非該当42.9%、差+5.5pt）
- **理論仮説：** チェインレースド クラッシャー + 自然の力（未観測；共通stats: 魔法防御・移動速度／チャンピオン原典にも言及: 魔法防御・移動速度）；終わりなき絶望 + ソーンメイル（n=2（15未満）；共通stats: 物理防御・体力／チャンピオン原典にも言及: 物理防御）

### MIDDLE（79試合）

- **実測ビルド候補：** ムラマナ + 妖夢の霊剣（該当n=30、66.7% / 非該当46.9%、差+19.7pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** ガーディアン エンジェル + デス ダンス（未観測；共通stats: 物理防御・攻撃力／チャンピオン原典にも言及: 物理防御）；スピリット ビサージュ + ホロウ レディアンス（未観測；共通stats: 体力・魔法防御／チャンピオン原典にも言及: 魔法防御）
