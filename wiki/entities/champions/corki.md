...
- **理論仮説：** [[wiki/entities/items/item-3078|トリニティ フォース]] + [[wiki/entities/items/item-3161|ショウジンの矛]]（n=3（15未満）；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）；[[wiki/entities/items/item-3071|ブラック クリーバー]] + [[wiki/entities/items/item-3161|ショウジンの矛]]（n=3（15未満）；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）
...
- **読み方：** [[reports/riot-champion-matchups/run-20260915T071824Z/champions/champion-42|詳細な候補表]]。実測の記述統計であり、因果的なシナジー、確定カウンター、推奨編成を意味しない。

### BOTTOM（対象n=131）

- **高勝率コンボ候補（最大3件）：** n=15以上の味方組み合わせなし。サンプル不足のため判断保留。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率26.7%（4/15）、サンプル不足（n=15、十分性の目安30未満）。
...
### BOTTOM（対象31試合、全体勝率41.9%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／冷静沈着・レジェンド: 迅速・切り崩し；副系天啓：キャッシュバック・トリプル トニック；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 5/31 | 16.1% | 60.0% |
| 2 | 主系栄華：フリートフットワーク／体力吸収・レジェンド: 迅速・切り崩し；副系不滅：ボーンアーマー・気迫；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 3/31 | 9.7% | 0.0% |
| 3 | 主系栄華：征服者／冷静沈着・レジェンド: 血脈・切り崩し；副系天啓：キャッシュバック・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 2/31 | 6.5% | 100.0% |
