...
「息継ぎ」は、不滅（Resolve）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット3（第2列）に配置されている。
...
- スロット番号: `3`
- スロット種別: 第2列
- アイコンパス: `perk-images/Styles/Resolve/SecondWind/SecondWind.png`

## 効果（短い説明）

敵チャンピオンからダメージを受けると、減少体力の一部を時間をかけて回復する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 不滅 / 息継ぎ レコード。
