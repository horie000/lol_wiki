...
- **高勝率コンボ候補：** [[wiki/entities/champions/swain|スウェイン（Swain）]] — 対象側勝率66.7%（12/18）、サンプル不足（n=18、十分性の目安30未満）。
- **カウンターピック候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率51.6%（16/31）、n=31（十分性の目安を満たす）。
