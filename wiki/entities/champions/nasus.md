...
### TOP（対象595試合、全体勝率50.3%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：フリートフットワーク／凱旋・レジェンド: ヘイスト・背水の陣；副系不滅：息継ぎ・気迫；シャードUNKNOWN(5007)・UNKNOWN(5001)・UNKNOWN(5001) | 288/595 | 48.4% | 50.7% |
| 2 | 主系魔道：嵐乗りの勇躍／マナフローバンド・至高・追火；副系天啓：疾駆・ビスケットデリバリー；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 31/595 | 5.2% | 61.3% |
| 3 | 主系栄華：フリートフットワーク／凱旋・レジェンド: ヘイスト・背水の陣；副系不滅：気迫・息継ぎ；シャードUNKNOWN(5007)・UNKNOWN(5001)・UNKNOWN(5001) | 22/595 | 3.7% | 45.5% |
