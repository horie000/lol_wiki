...
- **高勝率コンボ候補：** [[wiki/entities/champions/senna|セナ（Senna）]] — 対象側勝率66.0%（33/50）、n=50（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率35.5%（60/169）、n=169（十分性の目安を満たす）。
