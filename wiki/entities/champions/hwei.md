...
- **高勝率コンボ候補：** [[wiki/entities/champions/ambessa|アンベッサ（Ambessa）]] — 対象側勝率65.7%（23/35）、n=35（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/galio|ガリオ（Galio）]] — 対象側勝率33.3%（12/36）、n=36（十分性の目安を満たす）。

### BOTTOM（対象n=82）

- **高勝率コンボ候補：** [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率58.8%（10/17）、サンプル不足（n=17、十分性の目安30未満）。
