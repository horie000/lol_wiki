...
- **高勝率コンボ候補：** [[wiki/entities/champions/kaisa|カイ＝サ（Kaisa）]] — 対象側勝率46.9%（15/32）、n=32（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率52.4%（22/42）、n=42（十分性の目安を満たす）。
