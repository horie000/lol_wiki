...
- **実測ビルド候補：** フィンブルウィンター + ソラリのロケット（該当n=32、68.8% / 非該当52.3%、差+16.4pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** バンドルパイプ + ソラリのロケット（n=5（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 物理防御・体力）；ジーク コンバージェンス + ソラリのロケット（n=2（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 物理防御・体力）
