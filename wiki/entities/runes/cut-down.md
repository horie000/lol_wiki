...
「切り崩し」は、栄華（Precision）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット4（第3列）に配置されている。
...
- スロット番号: `4`
- スロット種別: 第3列
- アイコンパス: `perk-images/Styles/Precision/CutDown/CutDown.png`

## 効果（短い説明）

体力の多い敵チャンピオンに対して与えるダメージが増加する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 栄華 / 切り崩し レコード。
