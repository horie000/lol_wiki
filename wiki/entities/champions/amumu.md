...
- **高勝率コンボ候補：** [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率57.4%（31/54）、n=54（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/briar|ブライアー（Briar）]] — 対象側勝率38.1%（8/21）、サンプル不足（n=21、十分性の目安30未満）。
