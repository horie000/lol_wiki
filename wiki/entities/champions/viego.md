...
- **高勝率コンボ候補：** [[wiki/entities/champions/karma|カルマ（Karma）]] — 対象側勝率69.4%（25/36）、n=36（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/vi|ヴァイ（Vi）]] — 対象側勝率35.2%（19/54）、n=54（十分性の目安を満たす）。
