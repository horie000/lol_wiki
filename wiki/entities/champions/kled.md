...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率20.0%（3/15）、サンプル不足（n=15、十分性の目安30未満）。
...
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系不滅：ボーンアーマー・打ちこわし；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 10/58 | 17.2% | 40.0% |
| 2 | 主系不滅：不死者の握撃／打ちこわし・息継ぎ・超成長；副系栄華：背水の陣・レジェンド: 迅速；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 6/58 | 10.3% | 50.0% |
| 3 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系不滅：ボーンアーマー・打ちこわし；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 5/58 | 8.6% | 20.0% |
