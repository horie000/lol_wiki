...
- **実測ビルド候補：** メジャイ ソウルスティーラー + リッチ ベイン（該当n=32、75.0% / 非該当46.5%、差+28.5pt）；テルミヌス + クラーケン スレイヤー（該当n=35、65.7% / 非該当47.2%、差+18.5pt）
- **ステータス傾向：** 体力（該当n=285、51.2% / 非該当41.9%、差+9.3pt）；体力再生（該当n=38、55.3% / 非該当48.2%、差+7.0pt）
- **理論仮説：** スタティック シヴ + クラーケン スレイヤー（n=1（15未満）；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 移動速度）；ガンメタル ブーツ + クラーケン スレイヤー（n=2（15未満）；共通stats: 攻撃速度・移動速度／チャンピオン原典にも言及: 移動速度）
