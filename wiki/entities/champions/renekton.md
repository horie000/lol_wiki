...
- **高勝率コンボ候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率63.8%（37/58）、n=58（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/illaoi|イラオイ（Illaoi）]] — 対象側勝率35.1%（13/37）、n=37（十分性の目安を満たす）。
