...
- **実測ビルド候補：** ゾーニャの砂時計 + 連呪使いのブーツ + ライアンドリーの仮面（該当n=34、76.5% / 非該当51.0%、差+25.5pt）；ゾーニャの砂時計 + 連呪使いのブーツ（該当n=43、72.1% / 非該当50.8%、差+21.2pt）
- **ステータス傾向：** 物理防御（該当n=96、64.6% / 非該当48.6%、差+15.9pt）；魔法防御（該当n=39、59.0% / 非該当53.3%、差+5.6pt）
- **理論仮説：** リーライ クリスタル セプター + ブラッドレターの呪い（n=13（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）；リーライ クリスタル セプター + ライアンドリーの仮面 + ロッド オブ エイジス（n=13（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）

### BOTTOM（48試合）

- **実測ビルド候補：** 該当・非該当が各30試合以上で正の差を持つ候補なし。
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** ライアンドリーの仮面 + ブラッドレターの呪い（n=11（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）；リーライ クリスタル セプター + ブラッドレターの呪い（n=11（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）
