...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/morgana|モルガナ（Morgana）]] — 対象側勝率64.3%（27/42）、n=42（十分性の目安を満たす）。
  - [[wiki/entities/champions/garen|ガレン（Garen）]] — 対象側勝率62.5%（30/48）、n=48（十分性の目安を満たす）。
  - [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率56.6%（43/76）、n=76（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/lucian|ルシアン（Lucian）]] — 対象側勝率40.0%（14/35）、n=35（十分性の目安を満たす）。
  - [[wiki/entities/champions/miss-fortune|ミス・フォーチュン（MissFortune）]] — 対象側勝率41.8%（33/79）、n=79（十分性の目安を満たす）。
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率42.1%（32/76）、n=76（十分性の目安を満たす）。
...
### BOTTOM（対象488試合、全体勝率46.5%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系魔道：秘儀の彗星／マナフローバンド・至高・追火；副系天啓：キャッシュバック・トリプル トニック；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 116/488 | 23.8% | 37.1% |
| 2 | 主系栄華：リーサルテンポ／体力吸収・レジェンド: 迅速・切り崩し；副系天啓：ビスケットデリバリー・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 110/488 | 22.5% | 42.7% |
| 3 | 主系栄華：リーサルテンポ／凱旋・レジェンド: 迅速・切り崩し；副系天啓：キャッシュバック・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 39/488 | 8.0% | 59.0% |
