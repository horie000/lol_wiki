...
- **高勝率コンボ候補：** [[wiki/entities/champions/veigar|ベイガー（Veigar）]] — 対象側勝率67.6%（25/37）、n=37（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/dr-mundo|ドクター・ムンド（DrMundo）]] — 対象側勝率26.7%（8/30）、n=30（十分性の目安を満たす）。
