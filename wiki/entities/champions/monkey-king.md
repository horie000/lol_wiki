...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/viktor|ビクター（Viktor）]] — 対象側勝率62.9%（22/35）、n=35（十分性の目安を満たす）。
  - [[wiki/entities/champions/ashe|アッシュ（Ashe）]] — 対象側勝率58.0%（29/50）、n=50（十分性の目安を満たす）。
  - [[wiki/entities/champions/seraphine|セラフィーン（Seraphine）]] — 対象側勝率54.8%（17/31）、n=31（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率36.4%（12/33）、n=33（十分性の目安を満たす）。
  - [[wiki/entities/champions/viego|ヴィエゴ（Viego）]] — 対象側勝率54.5%（18/33）、n=33（十分性の目安を満たす）。
...
### JUNGLE（対象430試合、全体勝率49.8%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系天啓：宇宙の英知・魔法の靴；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 213/430 | 49.5% | 49.3% |
| 2 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系天啓：魔法の靴・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 62/430 | 14.4% | 50.0% |
| 3 | 主系栄華：征服者／凱旋・レジェンド: 迅速・最期の慈悲；副系覇道：サドンインパクト・至極の賞金首狩り；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 48/430 | 11.2% | 50.0% |
