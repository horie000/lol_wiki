...
### UTILITY（対象250試合、全体勝率53.2%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系不滅：アフターショック／生命の泉・ボーンアーマー・気迫；副系天啓：宇宙の英知・ヘクステックフラッシュネイター；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 65/250 | 26.0% | 50.8% |
| 2 | 主系覇道：ヘイルブレード／サドンインパクト・第六感・貪欲な賞金首狩り；副系天啓：宇宙の英知・ヘクステックフラッシュネイター；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 46/250 | 18.4% | 56.5% |
| 3 | 主系覇道：ヘイルブレード／サドンインパクト・第六感・貪欲な賞金首狩り；副系栄華：最期の慈悲・凱旋；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 15/250 | 6.0% | 53.3% |
