...
- **実測ビルド候補：** マリグナンス + シャドウフレイム（該当n=31、64.5% / 非該当52.9%、差+11.6pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** マリグナンス + ルーデン エコー（n=5（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）；メジャイ ソウルスティーラー + ヘクステック ロケットベルト（n=2（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）
