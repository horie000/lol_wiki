...
- **実測ビルド候補：** ブラック クリーバー + トリニティ フォース（該当n=95、56.8% / 非該当38.1%、差+18.7pt）；ステラックの篭手 + ブラック クリーバー + トリニティ フォース（該当n=33、57.6% / 非該当45.3%、差+12.3pt）
- **ステータス傾向：** 物理防御（該当n=137、47.4% / 非該当47.3%、差+0.2pt）
- **理論仮説：** スタティック シヴ + クラーケン スレイヤー（未観測；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 攻撃力・移動速度）；スタティック シヴ + ハルブレイカー（未観測；共通stats: 攻撃力・移動速度／チャンピオン原典にも言及: 攻撃力・移動速度）
