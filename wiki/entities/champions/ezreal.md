...
- **実測ビルド候補：** トリニティ フォース + 真紅のアイオニア ブーツ（該当n=81、66.7% / 非該当46.8%、差+19.9pt）；ムラマナ + トリニティ フォース + 真紅のアイオニア ブーツ（該当n=81、66.7% / 非該当46.8%、差+19.9pt）
- **ステータス傾向：** 魔法防御（該当n=74、59.5% / 非該当47.4%、差+12.1pt）；攻撃速度（該当n=1156、48.8% / 非該当38.8%、差+10.0pt）
- **理論仮説：** スタティック シヴ + クラーケン スレイヤー（未観測；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 攻撃速度）；トリニティ フォース + ルインドキング ブレード（n=2（15未満）；共通stats: 攻撃力・攻撃速度／チャンピオン原典にも言及: 攻撃速度）

### MIDDLE（33試合）

- **実測ビルド候補：** 該当・非該当が各30試合以上で正の差を持つ候補なし。
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** アクチュアライザー + マリグナンス（n=1（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）；アクチュアライザー + ルーデン エコー（n=1（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）
