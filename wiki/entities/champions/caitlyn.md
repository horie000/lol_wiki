...
- **高勝率コンボ候補：** [[wiki/entities/champions/malzahar|マルザハール（Malzahar）]] — 対象側勝率63.5%（47/74）、n=74（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率43.6%（78/179）、n=179（十分性の目安を満たす）。
