...
「宇宙の英知」は、天啓（Inspiration）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット4（第3列）に配置されている。
...
- スロット番号: `4`
- スロット種別: 第3列
- アイコンパス: `perk-images/Styles/Inspiration/CosmicInsight/CosmicInsight.png`
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 天啓 / 宇宙の英知 レコード。
