...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率50.0%（10/20）、サンプル不足（n=20、十分性の目安30未満）。
  - [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率50.0%（8/16）、サンプル不足（n=16、十分性の目安30未満）。
  - [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率47.1%（8/17）、サンプル不足（n=17、十分性の目安30未満）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/garen|ガレン（Garen）]] — 対象側勝率33.3%（7/21）、サンプル不足（n=21、十分性の目安30未満）。
...
### TOP（対象117試合、全体勝率39.3%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系魔道：嵐乗りの勇躍／マナフローバンド・至高・追火；副系天啓：ビスケットデリバリー・宇宙の英知；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 25/117 | 21.4% | 36.0% |
| 2 | 主系魔道：嵐乗りの勇躍／マナフローバンド・至高・追火；副系天啓：ビスケットデリバリー・宇宙の英知；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5011) | 16/117 | 13.7% | 37.5% |
| 3 | 主系魔道：嵐乗りの勇躍／マナフローバンド・至高・追火；副系天啓：魔法の靴・宇宙の英知；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5011) | 12/117 | 10.3% | 75.0% |
...
| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| EMERALD | 1 | 20 | 15勝/5敗 | 75.0% |

### 低勝率候補（下位5）

| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| PLATINUM | 1 | 23 | 3勝/20敗 | 13.0% |
