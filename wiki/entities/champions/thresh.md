...
- **高勝率コンボ候補：** [[wiki/entities/champions/veigar|ベイガー（Veigar）]] — 対象側勝率66.7%（32/48）、n=48（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/rakan|ラカン（Rakan）]] — 対象側勝率31.2%（10/32）、n=32（十分性の目安を満たす）。
