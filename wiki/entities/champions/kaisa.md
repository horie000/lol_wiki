...
- **高勝率コンボ候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率59.1%（91/154）、n=154（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/lucian|ルシアン（Lucian）]] — 対象側勝率34.8%（16/46）、n=46（十分性の目安を満たす）。
