...
- **実測ビルド候補：** ガーディアン エンジェル + ブラック クリーバー（該当n=70、64.3% / 非該当47.5%、差+16.7pt）；ステラックの篭手 + サンダード スカイ（該当n=63、63.5% / 非該当47.9%、差+15.6pt）
- **ステータス傾向：** クリティカル率（該当n=91、54.9% / 非該当48.5%、差+6.4pt）；物理防御（該当n=425、50.1% / 非該当48.0%、差+2.1pt）
- **理論仮説：** 実験的ヘクスプレート + トリニティ フォース（未観測；共通stats: 攻撃力・攻撃速度・体力／チャンピオン原典にも言及: 攻撃力・攻撃速度・体力）；ジーク コンバージェンス + 変幻自在のジャック＝ショー（n=1（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 物理防御・体力）
