...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/tahm-kench|タム・ケンチ（TahmKench）]] — 対象側勝率76.7%（23/30）、n=30（十分性の目安を満たす）。
  - [[wiki/entities/champions/master-yi|マスター・イー（MasterYi）]] — 対象側勝率69.0%（40/58）、n=58（十分性の目安を満たす）。
  - [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率60.7%（88/145）、n=145（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/aatrox|エイトロックス（Aatrox）]] — 対象側勝率41.2%（40/97）、n=97（十分性の目安を満たす）。
  - [[wiki/entities/champions/ambessa|アンベッサ（Ambessa）]] — 対象側勝率42.9%（21/49）、n=49（十分性の目安を満たす）。
  - [[wiki/entities/champions/k-sante|カ・サンテ（KSante）]] — 対象側勝率46.6%（34/73）、n=73（十分性の目安を満たす）。

### JUNGLE（対象n=167）

- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/ambessa|アンベッサ（Ambessa）]] — 対象側勝率50.0%（9/18）、サンプル不足（n=18、十分性の目安30未満）。
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率46.7%（7/15）、サンプル不足（n=15、十分性の目安30未満）。
...
### TOP（対象924試合、全体勝率50.4%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系不滅：ボーンアーマー・生気付与；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 497/924 | 53.8% | 52.7% |
| 2 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系魔道：強まる嵐・至高；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5001) | 114/924 | 12.3% | 51.8% |
| 3 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系不滅：生気付与・ボーンアーマー；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 42/924 | 4.5% | 52.4% |
