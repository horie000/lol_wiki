...
- **高勝率コンボ候補（最大3件）：**
  ...
  - [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率61.1%（11/18）、サンプル不足（n=18、十分性の目安30未満）。
  - [[wiki/entities/champions/ezreal|エズリアル（Ezreal）]] — 対象側勝率52.9%（9/17）、サンプル不足（n=17、十分性の目安30未満）。
...
### TOP（対象265試合、全体勝率52.1%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系天啓：キャッシュバック・なんでも屋；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5013) | 67/265 | 25.3% | 53.7% |
| 2 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系天啓：キャッシュバック・なんでも屋；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5001) | 38/265 | 14.3% | 52.6% |
| 3 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・背水の陣；副系天啓：キャッシュバック・なんでも屋；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5011) | 28/265 | 10.6% | 50.0% |
...
| --- | ---: | ---: | ---: | --- | ---: |
| GRANDMASTER | 3 | 205 | 2.1% | 110勝/95敗 | 53.7% |

### 高勝率候補（上位5）

| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| DIAMOND | 4 | 19 | 12勝/7敗 | 63.2% |
