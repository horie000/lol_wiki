...
- `scripts/riot_ranked_match_analyzer.py` — aggregate champion, item, rune, champion-by-rune selection, summoner-spell, performance, duration, and optional matchup reports. Champion-by-rune rates use the same champion/role participant denominator and remain descriptive rather than causal.
