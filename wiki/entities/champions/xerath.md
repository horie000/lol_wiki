...
- **高勝率コンボ候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率57.6%（95/165）、n=165（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/seraphine|セラフィーン（Seraphine）]] — 対象側勝率50.0%（20/40）、n=40（十分性の目安を満たす）。

### MIDDLE（対象n=544）

- **高勝率コンボ候補：** [[wiki/entities/champions/mordekaiser|モルデカイザー（Mordekaiser）]] — 対象側勝率64.3%（27/42）、n=42（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/hwei|フェイ（Hwei）]] — 対象側勝率46.2%（18/39）、n=39（十分性の目安を満たす）。
