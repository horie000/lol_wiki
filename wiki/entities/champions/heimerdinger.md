...
- **実測ビルド候補：** 黒炎のトーチ + ラバドン デスキャップ（該当n=34、70.6% / 非該当50.0%、差+20.6pt）；黒炎のトーチ + ライアンドリーの仮面（該当n=100、59.0% / 非該当48.5%、差+10.5pt）
- **ステータス傾向：** 物理防御（該当n=141、53.9% / 非該当51.6%、差+2.3pt）；マナ（該当n=184、53.3% / 非該当52.0%、差+1.3pt）
- **理論仮説：** 黒炎のトーチ + セラフ エンブレイス（n=2（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）；黒炎のトーチ + ルーデン エコー（n=2（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）

### MIDDLE（69試合）

- **実測ビルド候補：** 黒炎のトーチ + 連呪使いのブーツ（該当n=35、57.1% / 非該当50.0%、差+7.1pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** 黒炎のトーチ + ルーデン エコー（n=3（15未満）；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）；リーライ クリスタル セプター + ライアンドリーの仮面（n=11（15未満）；共通stats: 魔力・体力／スキル相互作用は未検証）
