...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率62.5%（10/16）、サンプル不足（n=16、十分性の目安30未満）。
  - [[wiki/entities/champions/miss-fortune|ミス・フォーチュン（MissFortune）]] — 対象側勝率52.9%（9/17）、サンプル不足（n=17、十分性の目安30未満）。
  - [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率50.0%（9/18）、サンプル不足（n=18、十分性の目安30未満）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/master-yi|マスター・イー（MasterYi）]] — 対象側勝率54.2%（13/24）、サンプル不足（n=24、十分性の目安30未満）。
...
### JUNGLE（対象16試合、全体勝率43.8%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系不滅：アフターショック／生命の泉・心身調整・気迫；副系栄華：レジェンド: 迅速・凱旋；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 6/16 | 37.5% | 33.3% |
| 2 | 主系不滅：アフターショック／生命の泉・心身調整・気迫；副系栄華：凱旋・レジェンド: 迅速；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 4/16 | 25.0% | 50.0% |
| 3 | 主系不滅：アフターショック／生命の泉・心身調整・気迫；副系魔道：追い風・水走り；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 2/16 | 12.5% | 50.0% |
...
| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| GOLD | 2 | 20 | 14勝/6敗 | 70.0% |

### 低勝率候補（下位5）

| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| IRON | 3 | 16 | 5勝/11敗 | 31.2% |
