...
- **スナップショット：** 2026-09-15生成、キュー420、ユニーク試合9,736件、[[reports/riot-champion-item-synergy/run-20260915T060638Z/champions/champion-432|バードの詳細レポート]]。
...
- **ステータス傾向：** 魔法防御（該当n=93、47.3% / 非該当45.5%、差+1.9pt）；魔力（該当n=83、47.0% / 非該当46.2%、差+0.8pt）
- **理論仮説：** [[wiki/entities/items/item-3002|先人の道標]] + [[wiki/entities/items/item-3742|デッド マン プレート]]（未観測；共通stats: 物理防御・体力・移動速度／チャンピオン原典にも言及: 体力・移動速度）；[[wiki/entities/items/item-6653|ライアンドリーの仮面]] + [[wiki/entities/items/item-8010|ブラッドレターの呪い]]（n=2（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 魔力・体力）
...
- **読み方：** [[reports/riot-champion-matchups/run-20260915T071824Z/champions/champion-432|詳細な候補表]]。実測の記述統計であり、因果的なシナジー、確定カウンター、推奨編成を意味しない。

### UTILITY（対象n=285）

- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/ezreal|エズリアル（Ezreal）]] — 対象側勝率54.5%（18/33）、n=33（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/lulu|ルル（Lulu）]] — 対象側勝率38.9%（7/18）、サンプル不足（n=18、十分性の目安30未満）。
  - [[wiki/entities/champions/nautilus|ノーチラス（Nautilus）]] — 対象側勝率40.0%（6/15）、サンプル不足（n=15、十分性の目安30未満）。
  - [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率43.8%（7/16）、サンプル不足（n=16、十分性の目安30未満）。
...
### UTILITY（対象658試合、全体勝率49.8%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系覇道：電撃／追い打ち・ディープワード・執拗な賞金首狩り；副系魔道：追い風・追火；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 114/658 | 17.3% | 47.4% |
| 2 | 主系覇道：電撃／追い打ち・ディープワード・執拗な賞金首狩り；副系天啓：魔法の靴・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5010)・UNKNOWN(5011) | 65/658 | 9.9% | 41.5% |
| 3 | 主系覇道：電撃／追い打ち・ディープワード・貪欲な賞金首狩り；副系天啓：宇宙の英知・魔法の靴；シャードUNKNOWN(5005)・UNKNOWN(5010)・UNKNOWN(5001) | 43/658 | 6.5% | 44.2% |
