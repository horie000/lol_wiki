...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率71.0%（22/31）、n=31（十分性の目安を満たす）。
  - [[wiki/entities/champions/ashe|アッシュ（Ashe）]] — 対象側勝率54.5%（18/33）、n=33（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/viktor|ビクター（Viktor）]] — 対象側勝率42.1%（8/19）、サンプル不足（n=19、十分性の目安30未満）。
  - [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率50.0%（12/24）、サンプル不足（n=24、十分性の目安30未満）。
  - [[wiki/entities/champions/hwei|フェイ（Hwei）]] — 対象側勝率50.0%（9/18）、サンプル不足（n=18、十分性の目安30未満）。
...
### MIDDLE（対象153試合、全体勝率53.6%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系覇道：電撃／追い打ち・グリスリー メメント・執拗な賞金首狩り；副系栄華：最期の慈悲・冷静沈着；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 39/153 | 25.5% | 66.7% |
| 2 | 主系覇道：電撃／追い打ち・グリスリー メメント・執拗な賞金首狩り；副系魔道：マナフローバンド・追火；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 20/153 | 13.1% | 35.0% |
| 3 | 主系覇道：電撃／追い打ち・グリスリー メメント・執拗な賞金首狩り；副系栄華：冷静沈着・最期の慈悲；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 14/153 | 9.2% | 64.3% |
