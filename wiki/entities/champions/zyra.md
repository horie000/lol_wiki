...
- **実測ビルド候補：** 連呪使いのブーツ + ライアンドリーの仮面（該当n=42、83.3% / 非該当49.0%、差+34.3pt）；黒炎のトーチ + リーライ クリスタル セプター（該当n=37、56.8% / 非該当51.2%、差+5.5pt）
...
- **実測ビルド候補：** ゾーニャの砂時計 + ライアンドリーの仮面（該当n=205、56.6% / 非該当51.4%、差+5.2pt）；リーライ クリスタル セプター + シャドウフレイム + ライアンドリーの仮面（該当n=48、58.3% / 非該当53.3%、差+5.0pt）
- **ステータス傾向：** 物理防御（該当n=282、55.0% / 非該当51.7%、差+3.2pt）
- **理論仮説：** シュレリアの戦歌 + コズミック ドライブ（未観測；共通stats: 魔力・移動速度／チャンピオン原典にも言及: 移動速度）；黒炎のトーチ + マリグナンス（未観測；共通stats: 魔力・マナ／チャンピオン原典にも言及: マナ）
