...
- **高勝率コンボ候補：** [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率69.0%（29/42）、n=42（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/yasuo|ヤスオ（Yasuo）]] — 対象側勝率33.3%（10/30）、n=30（十分性の目安を満たす）。
