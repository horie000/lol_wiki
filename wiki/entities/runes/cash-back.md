...
「キャッシュバック」は、天啓（Inspiration）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット2（第1列）に配置されている。
...
- スロット番号: `2`
- スロット種別: 第1列
- アイコンパス: `perk-images/Styles/Inspiration/CashBack/CashBack2.png`

## 効果（短い説明）

レジェンダリーアイテムを購入する際に、一部のゴールドが戻ってくる。

## 効果（詳細）

レジェンダリーアイテムを購入する際に、ゴールドが7.5%戻ってくる。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 天啓 / キャッシュバック レコード。
