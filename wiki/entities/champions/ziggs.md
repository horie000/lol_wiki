...
- **高勝率コンボ候補：** [[wiki/entities/champions/briar|ブライアー（Briar）]] — 対象側勝率63.3%（19/30）、n=30（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/miss-fortune|ミス・フォーチュン（MissFortune）]] — 対象側勝率38.6%（17/44）、n=44（十分性の目安を満たす）。
