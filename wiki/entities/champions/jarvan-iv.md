...
- **高勝率コンボ候補：** [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率72.7%（24/33）、n=33（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/viego|ヴィエゴ（Viego）]] — 対象側勝率38.8%（19/49）、n=49（十分性の目安を満たす）。
