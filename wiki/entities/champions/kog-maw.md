...
### BOTTOM（対象52試合、全体勝率48.1%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：リーサルテンポ／凱旋・レジェンド: 血脈・背水の陣；副系不滅：心身調整・超成長；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 17/52 | 32.7% | 47.1% |
| 2 | 主系魔道：秘儀の彗星／マナフローバンド・英気集中・追火；副系栄華：切り崩し・冷静沈着；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 5/52 | 9.6% | 0.0% |
| 3 | 主系天啓：ファーストストライク／キャッシュバック・トリプル トニック・なんでも屋；副系魔道：マナフローバンド・強まる嵐；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 2/52 | 3.8% | 100.0% |
