...
- **高勝率コンボ候補：** [[wiki/entities/champions/akali|アカリ（Akali）]] — 対象側勝率65.8%（25/38）、n=38（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率36.8%（14/38）、n=38（十分性の目安を満たす）。
