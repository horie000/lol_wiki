...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/nautilus|ノーチラス（Nautilus）]] — 対象側勝率68.4%（13/19）、サンプル不足（n=19、十分性の目安30未満）。
  - [[wiki/entities/champions/ahri|アーリ（Ahri）]] — 対象側勝率66.7%（14/21）、サンプル不足（n=21、十分性の目安30未満）。
  - [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率63.2%（12/19）、サンプル不足（n=19、十分性の目安30未満）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/ezreal|エズリアル（Ezreal）]] — 対象側勝率48.4%（15/31）、n=31（十分性の目安を満たす）。
  - [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率58.8%（20/34）、n=34（十分性の目安を満たす）。
...
### BOTTOM（対象153試合、全体勝率57.5%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：リーサルテンポ／凱旋・レジェンド: 迅速・切り崩し；副系魔道：アクシオム アルカニスト・強まる嵐；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 63/153 | 41.2% | 49.2% |
| 2 | 主系栄華：リーサルテンポ／凱旋・レジェンド: 迅速・最期の慈悲；副系覇道：サドンインパクト・貪欲な賞金首狩り；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 13/153 | 8.5% | 53.8% |
| 3 | 主系栄華：プレスアタック／凱旋・レジェンド: 迅速・切り崩し；副系魔道：アクシオム アルカニスト・強まる嵐；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 8/153 | 5.2% | 50.0% |
...
| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| EMERALD | 4 | 49 | 34勝/15敗 | 69.4% |

### 低勝率候補（下位5）

| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| DIAMOND | 4 | 37 | 12勝/25敗 | 32.4% |
