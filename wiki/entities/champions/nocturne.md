...
- **高勝率コンボ候補：** [[wiki/entities/champions/sivir|シヴィア（Sivir）]] — 対象側勝率73.5%（36/49）、n=49（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/master-yi|マスター・イー（MasterYi）]] — 対象側勝率37.2%（16/43）、n=43（十分性の目安を満たす）。
