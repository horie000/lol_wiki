...
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/mordekaiser|モルデカイザー（Mordekaiser）]] — 対象側勝率56.1%（23/41）、n=41（十分性の目安を満たす）。
...
### TOP（対象225試合、全体勝率51.6%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系天啓：疾駆・ビスケットデリバリー；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 41/225 | 18.2% | 43.9% |
| 2 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系天啓：疾駆・ビスケットデリバリー；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5011) | 35/225 | 15.6% | 54.3% |
| 3 | 主系栄華：征服者／凱旋・レジェンド: 迅速・背水の陣；副系不滅：ボーンアーマー・生気付与；シャードUNKNOWN(5005)・UNKNOWN(5008)・UNKNOWN(5001) | 19/225 | 8.4% | 42.1% |
...
| 観測帯 | 候補順位 | 試合数 | 勝敗 | 勝率 |
| --- | ---: | ---: | --- | ---: |
| SILVER | 1 | 26 | 19勝/7敗 | 73.1% |
| GOLD | 1 | 20 | 14勝/6敗 | 70.0% |
