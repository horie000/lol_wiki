...
- **高勝率コンボ候補：** [[wiki/entities/champions/sivir|シヴィア（Sivir）]] — 対象側勝率70.3%（26/37）、n=37（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/ahri|アーリ（Ahri）]] — 対象側勝率40.3%（25/62）、n=62（十分性の目安を満たす）。
