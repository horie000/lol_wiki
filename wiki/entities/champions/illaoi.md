...
- **高勝率コンボ候補：** [[wiki/entities/champions/kaisa|カイ＝サ（Kaisa）]] — 対象側勝率59.6%（34/57）、n=57（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/garen|ガレン（Garen）]] — 対象側勝率29.4%（10/34）、n=34（十分性の目安を満たす）。
