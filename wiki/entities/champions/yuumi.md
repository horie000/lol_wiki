...
- **実測ビルド候補：** ミカエルの祝福 + アーデント センサー + ムーンストーンの再生（該当n=40、67.5% / 非該当31.8%、差+35.7pt）；アーデント センサー + ムーンストーンの再生（該当n=79、62.0% / 非該当28.5%、差+33.5pt）
- **ステータス傾向：** 体力（該当n=287、40.8% / 非該当18.1%、差+22.7pt）；移動速度（該当n=209、40.2% / 非該当29.8%、差+10.4pt）
- **理論仮説：** スタティック シヴ + グインソー レイジブレード（n=1（15未満）；共通stats: 魔力・攻撃力・攻撃速度／チャンピオン原典にも言及: 攻撃力・攻撃速度）；先人の道標 + デッド マン プレート（未観測；共通stats: 物理防御・体力・移動速度／チャンピオン原典にも言及: 体力・移動速度）
