...
- **実測ビルド候補：** ソーンメイル + 心の鋼（該当n=55、67.3% / 非該当46.4%、差+20.9pt）；終わりなき絶望 + ソーンメイル + 心の鋼（該当n=35、68.6% / 非該当48.1%、差+20.5pt）
- **ステータス傾向：** 魔法防御（該当n=137、54.7% / 非該当46.4%、差+8.4pt）
- **理論仮説：** バンドルパイプ + ジーク コンバージェンス（n=2（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 物理防御・魔法防御）；ジーク コンバージェンス + 変幻自在のジャック＝ショー（未観測；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 物理防御・魔法防御）
