...
- **高勝率コンボ候補：** [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率73.5%（36/49）、n=49（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率40.0%（36/90）、n=90（十分性の目安を満たす）。
