...
- **高勝率コンボ候補（最大3件）：**
  ...
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率57.1%（16/28）、サンプル不足（n=28、十分性の目安30未満）。
  - [[wiki/entities/champions/yone|ヨネ（Yone）]] — 対象側勝率53.8%（14/26）、サンプル不足（n=26、十分性の目安30未満）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率46.7%（7/15）、サンプル不足（n=15、十分性の目安30未満）。
  - [[wiki/entities/champions/briar|ブライアー（Briar）]] — 対象側勝率53.3%（8/15）、サンプル不足（n=15、十分性の目安30未満）。
...
### JUNGLE（対象130試合、全体勝率55.4%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系不滅：不死者の握撃／シールドバッシュ・心身調整・超成長；副系天啓：疾駆・魔法の靴；シャードUNKNOWN(5007)・UNKNOWN(5001)・UNKNOWN(5001) | 87/130 | 66.9% | 52.9% |
| 2 | 主系不滅：不死者の握撃／シールドバッシュ・心身調整・超成長；副系天啓：魔法の靴・疾駆；シャードUNKNOWN(5007)・UNKNOWN(5001)・UNKNOWN(5001) | 13/130 | 10.0% | 46.2% |
| 3 | 主系不滅：不死者の握撃／シールドバッシュ・心身調整・超成長；副系天啓：疾駆・魔法の靴；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 3/130 | 2.3% | 100.0% |
