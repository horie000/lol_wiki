...
「ヘクステックフラッシュネイター」は、天啓（Inspiration）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット2（第1列）に配置されている。

## 識別情報

- ルーンID: `8306`
- ルーンキー: `HextechFlashtraption`
- 系統ID: `8300`
- 系統キー: `Inspiration`
- 系統名: 天啓
...
- スロット番号: `2`
- スロット種別: 第1列
- アイコンパス: `perk-images/Styles/Inspiration/HextechFlashtraption/HextechFlashtraption.png`

## 効果（短い説明）

フラッシュがクールダウンに入ると「へクスフラッシュ」に置き換わる。

へクスフラッシュ: 詠唱後に指定位置に瞬間移動する。

## 効果（詳細）

フラッシュはクールダウン中「へクスフラッシュ」に置き換わる。

へクスフラッシュ: 2秒間詠唱してから指定した位置に瞬間移動する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 天啓 / ヘクステックフラッシュネイター レコード。
