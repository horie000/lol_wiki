...
「マナフローバンド」は、魔道（Sorcery）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット2（第1列）に配置されている。
...
- スロット番号: `2`
- スロット種別: 第1列
- アイコンパス: `perk-images/Styles/Sorcery/ManaflowBand/ManaflowBand.png`

## 効果（短い説明）

敵チャンピオンにスキルを当てるたびに最大マナが25ずつ恒久的に増加する(増加マナ上限は250)。

増加マナが250になると5秒ごとに減少マナの1%を回復する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 魔道 / マナフローバンド レコード。
