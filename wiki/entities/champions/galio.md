...
- **実測ビルド候補：** ソーンメイル + ゾーニャの砂時計（該当n=30、70.0% / 非該当49.4%、差+20.6pt）；ソーンメイル + リフトメーカー + ホロウ レディアンス（該当n=42、69.0% / 非該当49.1%、差+19.9pt）
...
- **理論仮説：** バンドルパイプ + ソラリのロケット（n=5（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 体力）；ジーク コンバージェンス + ソラリのロケット（n=2（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 体力）
