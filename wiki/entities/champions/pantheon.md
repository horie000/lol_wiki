...
- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/ezreal|エズリアル（Ezreal）]] — 対象側勝率62.5%（20/32）、n=32（十分性の目安を満たす）。
  - [[wiki/entities/champions/miss-fortune|ミス・フォーチュン（MissFortune）]] — 対象側勝率56.5%（26/46）、n=46（十分性の目安を満たす）。
  - [[wiki/entities/champions/malzahar|マルザハール（Malzahar）]] — 対象側勝率46.7%（14/30）、n=30（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/nautilus|ノーチラス（Nautilus）]] — 対象側勝率51.5%（17/33）、n=33（十分性の目安を満たす）。

### JUNGLE（対象n=310）

- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率64.7%（11/17）、サンプル不足（n=17、十分性の目安30未満）。
  - [[wiki/entities/champions/kaisa|カイ＝サ（Kaisa）]] — 対象側勝率64.7%（11/17）、サンプル不足（n=17、十分性の目安30未満）。
  - [[wiki/entities/champions/ezreal|エズリアル（Ezreal）]] — 対象側勝率57.9%（11/19）、サンプル不足（n=19、十分性の目安30未満）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/lillia|リリア（Lillia）]] — 対象側勝率46.7%（7/15）、サンプル不足（n=15、十分性の目安30未満）。
...
### UTILITY（対象688試合、全体勝率45.9%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系栄華：プレスアタック／凱旋・レジェンド: ヘイスト・最期の慈悲；副系覇道：追い打ち・執拗な賞金首狩り；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 182/688 | 26.5% | 45.1% |
| 2 | 主系栄華：征服者／凱旋・レジェンド: ヘイスト・最期の慈悲；副系覇道：追い打ち・執拗な賞金首狩り；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 86/688 | 12.5% | 46.5% |
| 3 | 主系栄華：プレスアタック／凱旋・レジェンド: ヘイスト・最期の慈悲；副系天啓：宇宙の英知・ヘクステックフラッシュネイター；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 46/688 | 6.7% | 45.7% |
