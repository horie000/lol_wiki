...
### TOP（対象607試合、全体勝率48.6%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系不滅：不死者の握撃／シールドバッシュ・息継ぎ・超成長；副系天啓：ビスケットデリバリー・宇宙の英知；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 163/607 | 26.9% | 46.6% |
| 2 | 主系不滅：不死者の握撃／シールドバッシュ・息継ぎ・超成長；副系栄華：背水の陣・凱旋；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 67/607 | 11.0% | 52.2% |
| 3 | 主系不滅：不死者の握撃／シールドバッシュ・息継ぎ・超成長；副系栄華：レジェンド: ヘイスト・背水の陣；シャードUNKNOWN(5005)・UNKNOWN(5001)・UNKNOWN(5001) | 34/607 | 5.6% | 50.0% |
