...
- **高勝率コンボ候補：** [[wiki/entities/champions/ahri|アーリ（Ahri）]] — 対象側勝率47.7%（21/44）、n=44（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率40.9%（18/44）、n=44（十分性の目安を満たす）。

### BOTTOM（対象n=274）

- **高勝率コンボ候補：** [[wiki/entities/champions/yorick|ヨリック（Yorick）]] — 対象側勝率50.0%（18/36）、n=36（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率41.2%（7/17）、サンプル不足（n=17、十分性の目安30未満）。
