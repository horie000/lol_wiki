...
- **高勝率コンボ候補：** [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率53.3%（24/45）、n=45（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/hwei|フェイ（Hwei）]] — 対象側勝率36.7%（11/30）、n=30（十分性の目安を満たす）。
