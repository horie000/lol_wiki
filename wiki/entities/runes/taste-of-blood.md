...
「血の味わい」は、覇道（Domination）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット2（第1列）に配置されている。
...
- スロット番号: `2`
- スロット種別: 第1列
- アイコンパス: `perk-images/Styles/Domination/TasteOfBlood/GreenTerror_TasteOfBlood.png`
...
回復量: レベルに応じて16 - 40(+増加攻撃力x0.1、+魔力x0.05)
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 覇道 / 血の味わい レコード。
