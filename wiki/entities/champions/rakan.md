...
- **実測ビルド候補：** 騎士の誓い + ソラリのロケット（該当n=33、57.6% / 非該当48.9%、差+8.7pt）；ジーク コンバージェンス + 騎士の誓い（該当n=31、54.8% / 非該当49.2%、差+5.6pt）
- **ステータス傾向：** 魔法防御（該当n=314、50.0% / 非該当47.7%、差+2.3pt）；魔力（該当n=152、50.7% / 非該当49.0%、差+1.6pt）
- **理論仮説：** 先人の道標 + 自然の力（未観測；共通stats: 体力・移動速度／チャンピオン原典にも言及: 体力・移動速度）；バンドルパイプ + ソラリのロケット（n=10（15未満）；共通stats: 物理防御・体力・魔法防御／チャンピオン原典にも言及: 体力）
