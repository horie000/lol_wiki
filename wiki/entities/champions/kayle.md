...
- **高勝率コンボ候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率63.6%（21/33）、n=33（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/garen|ガレン（Garen）]] — 対象側勝率50.0%（11/22）、サンプル不足（n=22、十分性の目安30未満）。
