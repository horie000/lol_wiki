...
- **実測ビルド候補：** ドミニク リガード + コレクター（該当n=53、71.7% / 非該当46.6%、差+25.1pt）；インフィニティ エッジ + ドミニク リガード + コレクター（該当n=38、71.1% / 非該当48.3%、差+22.7pt）
- **ステータス傾向：** 魔力（該当n=104、51.9% / 非該当51.2%、差+0.7pt）
- **理論仮説：** スタティック シヴ + クラーケン スレイヤー（未観測；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 攻撃力・移動速度）；タイタン ハイドラ + ケミパンク チェーンソード（未観測；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）
