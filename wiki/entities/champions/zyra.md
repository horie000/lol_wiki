...
- **高勝率コンボ候補：** [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率69.2%（27/39）、n=39（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率46.8%（29/62）、n=62（十分性の目安を満たす）。

### JUNGLE（対象n=551）

- **高勝率コンボ候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率58.5%（31/53）、n=53（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jarvan-iv|ジャーヴァンⅣ（JarvanIV）]] — 対象側勝率25.0%（5/20）、サンプル不足（n=20、十分性の目安30未満）。
