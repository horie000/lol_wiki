...
- **実測ビルド候補：** [[wiki/entities/items/item-3504|アーデント センサー]] + [[wiki/entities/items/item-6620|ヘリアの残響]]（該当n=45、62.2% / 非該当45.9%、差+16.3pt）；[[wiki/entities/items/item-6617|ムーンストーンの再生]] + [[wiki/entities/items/item-6620|ヘリアの残響]]（該当n=73、52.1% / 非該当47.9%、差+4.1pt）
- **ステータス傾向：** 該当・非該当が各30試合以上で正の差を持つ群なし。
- **理論仮説：** [[wiki/entities/items/item-2530|旋律のダイアデム]] + [[wiki/entities/items/item-6657|ロッド オブ エイジス]]（n=1（15未満）；共通stats: 体力・マナ／チャンピオン原典にも言及: 体力・マナ）；[[wiki/entities/items/item-2065|シュレリアの戦歌]] + [[wiki/entities/items/item-3504|アーデント センサー]]（n=5（15未満）；共通stats: 魔力・移動速度／チャンピオン原典にも言及: 移動速度）
...
- **読み方：** [[reports/riot-champion-matchups/run-20260915T071824Z/champions/champion-902|詳細な候補表]]。実測の記述統計であり、因果的なシナジー、確定カウンター、推奨編成を意味しない。

### UTILITY（対象n=415）

- **高勝率コンボ候補（最大3件）：**
  - [[wiki/entities/champions/smolder|スモルダー（Smolder）]] — 対象側勝率61.1%（22/36）、n=36（十分性の目安を満たす）。
  - [[wiki/entities/champions/jinx|ジンクス（Jinx）]] — 対象側勝率60.4%（29/48）、n=48（十分性の目安を満たす）。
  - [[wiki/entities/champions/lucian|ルシアン（Lucian）]] — 対象側勝率54.1%（33/61）、n=61（十分性の目安を満たす）。
- **低勝率カウンターピック候補（最大3件）：**
  - [[wiki/entities/champions/nami|ナミ（Nami）]] — 対象側勝率41.2%（7/17）、サンプル不足（n=17、十分性の目安30未満）。
  - [[wiki/entities/champions/seraphine|セラフィーン（Seraphine）]] — 対象側勝率42.3%（11/26）、サンプル不足（n=26、十分性の目安30未満）。
  - [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率48.3%（14/29）、サンプル不足（n=29、十分性の目安30未満）。
...
### UTILITY（対象162試合、全体勝率49.4%）

| 順位 | 完全ルーンセット | 選択数 | 選択率 | 選択時勝率 |
| ---: | --- | ---: | ---: | ---: |
| 1 | 主系魔道：エアリー召喚／マナフローバンド・至高・追火；副系不滅：ボーンアーマー・生気付与；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5001) | 68/162 | 42.0% | 47.1% |
| 2 | 主系魔道：エアリー召喚／マナフローバンド・至高・追火；副系天啓：ビスケットデリバリー・宇宙の英知；シャードUNKNOWN(5008)・UNKNOWN(5008)・UNKNOWN(5001) | 11/162 | 6.8% | 54.5% |
| 3 | 主系魔道：エアリー召喚／マナフローバンド・至高・強まる嵐；副系不滅：ボーンアーマー・生気付与；シャードUNKNOWN(5007)・UNKNOWN(5008)・UNKNOWN(5001) | 7/162 | 4.3% | 57.1% |
