...
- **実測ビルド候補：** ドミニク リガード + コレクター（該当n=55、65.5% / 非該当41.8%、差+23.7pt）；インフィニティ エッジ + コレクター（該当n=67、64.2% / 非該当40.6%、差+23.6pt）
- **ステータス傾向：** 体力（該当n=54、57.4% / 非該当44.3%、差+13.1pt）；クリティカル率（該当n=195、49.2% / 非該当38.1%、差+11.1pt）
- **理論仮説：** ブラック クリーバー + トリニティ フォース（n=3（15未満）；共通stats: 攻撃力・体力／チャンピオン原典にも言及: 攻撃力・体力）；インフィニティ エッジ + モータル リマインダー（n=9（15未満）；共通stats: 攻撃力・クリティカル率／チャンピオン原典にも言及: 攻撃力）
