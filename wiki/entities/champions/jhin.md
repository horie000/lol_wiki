...
- **実測ビルド候補：** ラピッド ファイアキャノン + 妖夢の霊剣 + スイフトマーチ（該当n=32、81.2% / 非該当51.2%、差+30.1pt）；インフィニティ エッジ + スイフトマーチ（該当n=98、79.6% / 非該当49.8%、差+29.8pt）
- **ステータス傾向：** ライフスティール（該当n=74、64.9% / 非該当51.1%、差+13.7pt）；魔法防御（該当n=74、62.2% / 非該当51.3%、差+10.9pt）
- **理論仮説：** ファントム ダンサー + ラピッド ファイアキャノン（n=3（15未満）；共通stats: 攻撃速度・クリティカル率・移動速度／チャンピオン原典にも言及: クリティカル率・移動速度）；スタティック シヴ + クラーケン スレイヤー（未観測；共通stats: 攻撃力・攻撃速度・移動速度／チャンピオン原典にも言及: 移動速度）
