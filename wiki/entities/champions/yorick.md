...
- **高勝率コンボ候補：** [[wiki/entities/champions/warwick|ワーウィック（Warwick）]] — 対象側勝率76.7%（23/30）、n=30（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/chogath|チョ＝ガス（Chogath）]] — 対象側勝率40.0%（20/50）、n=50（十分性の目安を満たす）。
