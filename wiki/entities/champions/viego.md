...
- **実測ビルド候補：** インフィニティ エッジ + クラーケン スレイヤー + イモータル シールドボウ（該当n=44、72.7% / 非該当46.9%、差+25.9pt）；インフィニティ エッジ + クラーケン スレイヤー（該当n=65、69.2% / 非該当46.6%、差+22.7pt）
- **ステータス傾向：** クリティカル率（該当n=798、48.9% / 非該当45.3%、差+3.6pt）；魔法防御（該当n=385、49.1% / 非該当47.2%、差+1.8pt）
- **理論仮説：** 実験的ヘクスプレート + トリニティ フォース（未観測；共通stats: 攻撃力・攻撃速度・体力／チャンピオン原典にも言及: 攻撃力・攻撃速度・体力）；トリニティ フォース + クラーケン スレイヤー（n=12（15未満）；共通stats: 攻撃力・攻撃速度／チャンピオン原典にも言及: 攻撃力・攻撃速度）
