...
- **実測ビルド候補：** ナッシャー トゥース + 連呪使いのブーツ（該当n=50、56.0% / 非該当42.3%、差+13.7pt）；ナッシャー トゥース + ライアンドリーの仮面（該当n=31、58.1% / 非該当44.4%、差+13.6pt）
- **ステータス傾向：** 物理防御（該当n=49、55.1% / 非該当43.1%、差+12.0pt）
- **理論仮説：** リーライ クリスタル セプター + ライアンドリーの仮面（n=8（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）；リフトメーカー + ライアンドリーの仮面（n=1（15未満）；共通stats: 魔力・体力／チャンピオン原典にも言及: 体力）
