...
- **高勝率コンボ候補：** [[wiki/entities/champions/irelia|イレリア（Irelia）]] — 対象側勝率67.7%（21/31）、n=31（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率37.8%（31/82）、n=82（十分性の目安を満たす）。
