...
- **高勝率コンボ候補：** [[wiki/entities/champions/caitlyn|ケイトリン（Caitlyn）]] — 対象側勝率63.5%（47/74）、n=74（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/hwei|フェイ（Hwei）]] — 対象側勝率38.1%（24/63）、n=63（十分性の目安を満たす）。
