...
「生気付与」は、不滅（Resolve）系統に属するルーン選択肢である。原典の `slots` 配列ではスロット4（第3列）に配置されている。
...
- スロット番号: `4`
- スロット種別: 第3列
- アイコンパス: `perk-images/Styles/Resolve/Revitalize/Revitalize.png`

## 効果（短い説明）

体力回復効果とシールド効果が5%上昇する。

自身が使用する、または付与される体力回復効果とシールド効果は、対象の体力が40%未満の場合、10%上昇する。
...
- [[wiki/sources/src-2026-09-14-dragontail-16-18-1|Data Dragon 配布アーカイブ v16.18.1]] — `16.18.1/data/ja_JP/runesReforged.json` の 不滅 / 生気付与 レコード。
