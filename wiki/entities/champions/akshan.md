...
- **高勝率コンボ候補：** [[wiki/entities/champions/zyra|ザイラ（Zyra）]] — 対象側勝率55.4%（46/83）、n=83（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/vex|ヴェックス（Vex）]] — 対象側勝率37.5%（6/16）、サンプル不足（n=16、十分性の目安30未満）。
