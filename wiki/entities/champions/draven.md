...
- **実測ビルド候補：** ブラッドサースター + コレクター（該当n=67、62.7% / 非該当49.5%、差+13.2pt）；インフィニティ エッジ + コレクター（該当n=39、64.1% / 非該当52.1%、差+12.0pt）
- **ステータス傾向：** 攻撃速度（該当n=100、57.0% / 非該当51.7%、差+5.3pt）；移動速度（該当n=108、56.5% / 非該当51.9%、差+4.6pt）
- **理論仮説：** フィーンドハンターの矢 + ラピッド ファイアキャノン（未観測；共通stats: 攻撃速度・クリティカル率・移動速度／チャンピオン原典にも言及: 攻撃速度・移動速度）；ラピッド ファイアキャノン + ガンメタル ブーツ（n=5（15未満）；共通stats: 攻撃速度・移動速度／チャンピオン原典にも言及: 攻撃速度・移動速度）
