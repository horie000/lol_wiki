...
- **高勝率コンボ候補：** [[wiki/entities/champions/galio|ガリオ（Galio）]] — 対象側勝率65.2%（30/46）、n=46（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/nocturne|ノクターン（Nocturne）]] — 対象側勝率46.8%（29/62）、n=62（十分性の目安を満たす）。
