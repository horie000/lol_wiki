...
- **高勝率コンボ候補：** [[wiki/entities/champions/leona|レオナ（Leona）]] — 対象側勝率66.7%（18/27）、サンプル不足（n=27、十分性の目安30未満）。
- **カウンターピック候補：** [[wiki/entities/champions/aatrox|エイトロックス（Aatrox）]] — 対象側勝率34.8%（8/23）、サンプル不足（n=23、十分性の目安30未満）。
