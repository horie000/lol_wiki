...
- **高勝率コンボ候補：** [[wiki/entities/champions/seraphine|セラフィーン（Seraphine）]] — 対象側勝率69.4%（25/36）、n=36（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率34.3%（24/70）、n=70（十分性の目安を満たす）。
