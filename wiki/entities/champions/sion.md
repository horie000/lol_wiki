...
- **高勝率コンボ候補：** [[wiki/entities/champions/sivir|シヴィア（Sivir）]] — 対象側勝率66.7%（26/39）、n=39（十分性の目安を満たす）。
- **カウンターピック候補：** [[wiki/entities/champions/yorick|ヨリック（Yorick）]] — 対象側勝率40.4%（19/47）、n=47（十分性の目安を満たす）。

### MIDDLE（対象n=288）

- **高勝率コンボ候補：** [[wiki/entities/champions/jhin|ジン（Jhin）]] — 対象側勝率73.1%（19/26）、サンプル不足（n=26、十分性の目安30未満）。
- **カウンターピック候補：** [[wiki/entities/champions/ahri|アーリ（Ahri）]] — 対象側勝率55.6%（10/18）、サンプル不足（n=18、十分性の目安30未満）。
